 ...
 */
public class ConnectMysql_Dev_m_kja_task_answer_Insert {

    private static String insert_sql = "INSERT INTO `yzmm`.`m_kja_task_answer` (`task_id`,`sort_num`,`item_id`,`title_id`,`subject_id`,`status`,`create_time`,`update_time`) VALUES  (?,?,?,?,?,?,?,?)";
    ...
    public static void doStore(List<KjaTaskAnswer> list) throws ClassNotFoundException, SQLException, IOException {
        ...
        for (int i = 0; i < list.size(); i++) {
            KjaTaskAnswer kjaTaskAnswer = list.get(i);
                psts.setLong(1, kjaTaskAnswer.getTaskId());
                psts.setDouble(2, kjaTaskAnswer.getSortNum());
                psts.setString(3,kjaTaskAnswer.getItemId());
                psts.setString(4,kjaTaskAnswer.getTitleId());
                psts.setString(5,kjaTaskAnswer.getSubjectId());
                psts.setInt(6,1);
                psts.setLong(7,time);
                psts.setLong(8,time);
