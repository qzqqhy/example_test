 ...
 */
public class ConnectMysql_Dev_m_kja_task_target_Insert {

    private static String [] targets={"让所有家庭成员（包括保姆）都能统一认识，了解入园准备的重要性，知道孩子入园前需要重点解决的问题有哪些。","让孩子在入园前，先对幼儿园有好奇心和好感，有“我想去上幼儿园”的愿望。","培养孩子的合作精神，同时让妈妈懂得如何提要求，孩子才会听。","给孩子创造机会，让他/她多和小伙伴一起玩，增加社交经验。","锻炼孩子的专注力，让孩子在幼儿园上课时能够坐得住。","锻炼孩子的社会适应性，帮助他/她今后更快地和幼儿园老师熟悉起来。","让孩子理解并学会遵守“轮流、等候”的社交规则，以便今后更快地适应幼儿园生活。","教孩子理解并遵守“先来后到”、“分享”、“求助”等社交规则，以便今后更快地适应幼儿园生活。","让孩子理解并学会“自我保护”和“尊重别人”，以便今后更快地适应幼儿园生活。","通过建立睡前流程，让孩子形成习惯，在睡前流程结束后就自主入睡。","调整孩子晚上的入睡时间，确保第二天早上可以准时起床。","能够在6:30-7:30之间起床，并且让起床变得轻松愉快。","调整孩子午睡的入睡方式，为孩子在幼儿园独自午睡做准备。","调整孩子的午睡时间，做到和幼儿园的作息保持一致，降低孩子在幼儿园午睡的难度。","训练孩子学会控制大便，增加孩子入园适应的自信心。","训练孩子学会控制小便，增加孩子入园适应的自信心。","树立吃饭的规则，教孩子好好吃饭。","让孩子学会在没有大人协助、没有其他事物干扰的情况下独立吃饭。","让孩子逐渐接受不同口味的事物，减少挑食。","让孩子学会主动表达口渴、想喝水的需求。","教孩子自己脱、穿衣服，让他/她学习照顾自己。","教孩子自己脱、穿裤子，提升孩子的生活自理能力和自信心。","教孩子自己脱、穿鞋。","培养孩子的劳动意识，学会简单的劳动技能，同时让妈妈学会有意识地鼓励孩子参与家务劳动。","让孩子熟悉自己的大名，并且能够做基本的自我介绍。","发展孩子的语言理解能力。","鼓励孩子把“想要的”说出来。","提高孩子的语言表达能力，让他/她说得更完整清晰。","锻炼孩子的胆量，让他/她敢和别人沟通。","帮孩子降低分离焦虑。","改善孩子和主要看护人的亲子依恋关系，增加孩子的安全感。","调整主要看护人的情绪，给孩子传导正面的心理暗示。"};


    private static String insert_sql = "INSERT INTO `yzmm`.`m_kja_task_target` (`target`,`status`,`create_time`,`update_time`) VALUES  (?,?,?,?)";
    ...
    private static void doStore() throws ClassNotFoundException, SQLException, IOException {
        ...
        conn.commit();  // 提交
        System.out.println("All down : " + resIndex);
        conn.close();
    }
